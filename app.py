...
if st.session_state.menu_aktif == "Main Program":
    ...
    if file_terunggah is not None:
        ...
        st.session_state.sudah_deteksi = False  # Reset hasil deteksi lama jika ganti foto baru
        ...
        if st.session_state.sudah_deteksi:
            ...
            if st.session_state.status_level != "Aman":
                ...
                if st.session_state.status_level == "Low":
                    ...
                    *Aksi Lapangan:* Bersihkan celah-celah retakan garis menggunakan udara bertekanan kompresor, kemudian injeksikan bahan pengisi berupa aspal cair panas (*sealant*) agar celah tutup rapat dan kedap dari rembesan air hujan.
                    """)
                elif st.session_state.status_level == "Medium":
                    st.warning("""
